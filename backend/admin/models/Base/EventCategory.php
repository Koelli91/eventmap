...
abstract class EventCategory implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EventCategoryTableMap';
    ...
    /**
     * Initializes internal state of Base\EventCategory object.
     */
    ...
    /**
     * Compares this with another <code>EventCategory</code> instance.  If
     * <code>obj</code> is an instance of <code>EventCategory</code>, delegates to
     * <code>equals(EventCategory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EventCategory The current object, for fluid interface
     */
    ...
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[EventCategoryTableMap::COL_EVENT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = EventCategoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EventCategory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEventCategoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EventCategory::setDeleted()
     * @see EventCategory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEventCategoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventCategoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO event_category (%s) VALUES (%s)',
    ...
    {
        $pos = EventCategoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['EventCategory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventCategory'][$this->hashCode()] = true;
    ...
    public function hashCode()
    {
        ...
        //relation event_category_fk_b54508 to table event
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EventCategory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EventCategory Clone of current object.
     * @throws PropelException
     */
    ...
    public function getEvent(ConnectionInterface $con = null)
    {
        if ($this->aEvent === null && ($this->event_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEvent->addEventCategories($this);
             */
        }
    ...
    public function getCategory(ConnectionInterface $con = null)
    {
        if ($this->aCategory === null && (($this->category_name !== "" && $this->category_name !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCategory->addEventCategories($this);
             */
        }
    ...
    {
        if (null !== $this->aEvent) {
            $this->aEvent->removeEventCategory($this);
        }
        if (null !== $this->aCategory) {
    ...
    {
        return (string) $this->exportTo(EventCategoryTableMap::DEFAULT_STRING_FORMAT);
    }

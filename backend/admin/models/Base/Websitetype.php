...
/**
 * Base class that represents a row from the 'websitetype' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class Websitetype implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\WebsitetypeTableMap';
    ...
    /**
     * Initializes internal state of Base\Websitetype object.
     */
    ...
    /**
     * Compares this with another <code>Websitetype</code> instance.  If
     * <code>obj</code> is an instance of <code>Websitetype</code>, delegates to
     * <code>equals(Websitetype)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Websitetype The current object, for fluid interface
     */
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[WebsitetypeTableMap::COL_TYPE] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWebsitetypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Websitetype::setDeleted()
     * @see Websitetype::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWebsitetypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WebsitetypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO websitetype (%s) VALUES (%s)',
    ...
    {
        $pos = WebsitetypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Websitetype'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Websitetype (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Websitetype Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildWebsitetype is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildWebsitetype The current object (for fluent API support)
     */
    public function setWebsites(Collection $websites, ConnectionInterface $con = null)
    {
        ...
        foreach ($websitesToDelete as $websiteRemoved) {
            $websiteRemoved->setWebsitetype(null);
        }
    ...
    {
        return (string) $this->exportTo(WebsitetypeTableMap::DEFAULT_STRING_FORMAT);
    }

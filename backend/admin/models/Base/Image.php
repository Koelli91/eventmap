...
abstract class Image implements ActiveRecordInterface 
{
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aImagetype) {
                ...
                $result[$key] = $this->aImagetype->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aEvent) {
    ...
    /**
     * Declares an association between this object and a ChildImagetype object.
     *
     * @param  ChildImagetype $v
     * @return $this|\Image The current object (for fluent API support)
     * @throws PropelException
     */
    public function setImagetype(ChildImagetype $v = null)
    {
        ...
        // If this object has already been added to the ChildImagetype object, it will not be re-added.
        if ($v !== null) {
            $v->addImage($this);
        }
    ...
    /**
     * Get the associated ChildImagetype object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildImagetype The associated ChildImagetype object.
     * @throws PropelException
     */
    public function getImagetype(ConnectionInterface $con = null)
    {
        if ($this->aImagetype === null && (($this->type !== "" && $this->type !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aImagetype->addImages($this);
             */
        }
    ...
    {
        if (null !== $this->aImagetype) {
            $this->aImagetype->removeImage($this);
        }
        if (null !== $this->aEvent) {

...
/**
 * Base class that represents a row from the 'imagetype' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class Imagetype implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ImagetypeTableMap';
    ...
    /**
     * Initializes internal state of Base\Imagetype object.
     */
    ...
    /**
     * Compares this with another <code>Imagetype</code> instance.  If
     * <code>obj</code> is an instance of <code>Imagetype</code>, delegates to
     * <code>equals(Imagetype)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Imagetype The current object, for fluid interface
     */
     ...
     * @return $this|\Imagetype The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ImagetypeTableMap::COL_ID] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[ImagetypeTableMap::COL_TYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ImagetypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ImagetypeTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ImagetypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Imagetype'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildImagetypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Imagetype::setDeleted()
     * @see Imagetype::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildImagetypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ImagetypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ImagetypeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ImagetypeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ImagetypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ImagetypeTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }

        $sql = sprintf(
            'INSERT INTO imagetype (%s) VALUES (%s)',
    ...
    {
        $pos = ImagetypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Imagetype'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Imagetype'][$this->hashCode()] = true;
        $keys = ImagetypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getType(),
        );
    ...
    {
        $criteria = new Criteria(ImagetypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ImagetypeTableMap::COL_ID)) {
            $criteria->add(ImagetypeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ImagetypeTableMap::COL_TYPE)) {
            $criteria->add(ImagetypeTableMap::COL_TYPE, $this->type);
        }
    ...
    {
        $criteria = ChildImagetypeQuery::create();
        $criteria->add(ImagetypeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Imagetype (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Imagetype Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildImagetype is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildImagetype The current object (for fluent API support)
     */
    public function setImages(Collection $images, ConnectionInterface $con = null)
    {
        ...
        foreach ($imagesToDelete as $imageRemoved) {
            $imageRemoved->setImagetype(null);
        }
     ...
     * Otherwise if this Imagetype is new, it will return
     * an empty collection; or if this Imagetype has previously
     * been saved, it will retrieve related Images from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Imagetype.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ImagetypeTableMap::DEFAULT_STRING_FORMAT);
    }
